...
public class Sportsman {
    ...
    public static void main(String[] args) {
        ...
        TreeSet <Sportsman> sportsman = new TreeSet<Sportsman>(new MedalComparators());
        ...
        TreeSet <Sportsman> sportsman2 = new TreeSet<Sportsman>(new GoldComparators());
        ...
        TreeSet<Sportsman> sportsman3 = new TreeSet<Sportsman>(new AgeComparators());
        ...
        for (Sportsman element : sportsman3){
            System.out.println("Sort Sportsmen by age " + element.name +" "+ element.age);
        }
